...
This week I read about "VIIRS Day/Night Band to Measure Electricity Supply Reliability: Preliminary Results from Maharashtra, India". In this study, M. Amani *et al* ([2016](https://doi.org/10.3390/rs8090711)). used VIIRS (Visible Infrared Imaging Radiometer Suite) images to measure the reliability of electricity supply in Maharashtra, India. In this study, they used the Random Forest model we learned about this week. This study provides a reliable and accurate method for measuring electricity supply reliability, as the VIIRS Day/Night Band data (providing high spatial and temporal resolution images of nighttime illumination) was able to capture both planned and unplanned outages. Therefore, this study will be a useful tool for measuring electricity supply reliability in developing countries where settlements occur continuously and frequently.
